...
class UniVSE(nn.Module):
    ...
    def __init__(self, vocab_encoder, input_size=300, hidden_size=1024, grad_clip=2.0, rnn_layers=1, train_cnn=False):
        """
    ...
    @classmethod
    def from_captions(cls, captions, glove_file, input_size=300, hidden_size=1024, grad_clip=2.0, rnn_layers=1,
                      train_cnn=False):
        """
    ...
    @classmethod
    def from_filename(cls, vocab_file, input_size=300, hidden_size=1024, grad_clip=2.0, rnn_layers=1,
                      train_cnn=False):
        """
        Initializes the Unified Visual Semantic Embeddings model and creates vocabulary
        encoder from scratch given a list of sentences and a file with GloVe embeddings
